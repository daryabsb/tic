<template>
    <Popover class="relative bg-white">
        ...
        <div class="relative z-20">
            <div
                class="mx-auto flex items-center justify-between py-5 px-6 sm:py-4 md:justify-start md:space-x-10 lg:px-8">
                <div>
                    <a href="#" class="flex">
                        <span class="sr-only">Your Company</span>
                        <img class="h-12 w-auto sm:h-16" src="~/assets/logos/tic-logo-01.svg" alt="" />
                    </a>
                </div>
                ...
                <div class="hidden md:flex md:flex-1 md:items-center md:justify-between">
                    <PopoverGroup as="nav" class="flex space-x-10">
                        <Popover v-slot="{ open }">
                            <PopoverButton
                                :class="[open ? 'text-gray-900' : 'text-gray-500', ' font-graphik-black-web group inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2']">
                                <span>Solutions</span>
                                <ChevronDownIcon
                        ...
                        <a href="#"
                            class="text-base font-graphik-black-web  text-gray-500 hover:text-gray-900">Pricing</a>
                                                        ...
                                                        <a :href="post.href"
                                                            ...
                                                            <div class="w-0 flex-1 sm:ml-8">
                                                                <h4
                                                                    ...
                                                                    {{ post.name }}</h4>
                                                                <p class="mt-1 text-sm text-gray-500">{{ post.preview }}
                                                                </p>
                                                            </div>
                                                        </a>
                                                    </li>
                ...
                <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                    ...
                    <div class="py-6 px-5">
                        <div class="grid grid-cols-2 gap-4">
                            <a href="#"
                                class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Pricing</a>
                            <a href="#"
                                class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Docs</a>
                            <a href="#"
                                class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Company</a>
                            <a href="#"
                                class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Resources</a>
                            <a href="#"
                                class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Blog</a>
                            <a href="#"
                                class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Contact
                                Sales</a>
                        </div>
                        <div class="mt-6">
                            <a href="#"
