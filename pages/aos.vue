<template>
    <main id="app">
        <section class='intro h-screen w-screen'>
        ...
        <section class='guide1 h-screen w-screen'>
        ...
        <section class='guide2 h-screen w-screen'>
            ...
            <img class='guide2Image'
                ...
                alt='3d illustration of boy with laptop sitting' data-aos="slide-up" data-aos-duration="1500"
                data-aos-ease='ease' data-aos-delay='1000' />
