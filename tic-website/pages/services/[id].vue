        ...
        <div class="overflow-hidden bg-white pt-24">
            <div class="relative mx-auto max-w-7xl py-16 px-6 lg:px-8">
                ...
                <div class="mx-auto max-w-prose text-base lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-8">
                    <div>
                        <h2 class="">
                            <a href="/services" class="text-lg uppercase text-blood">
                                services
                            </a>
                        </h2>
                        ...
                        <div class="relative mx-auto max-w-prose text-base lg:max-w-none">
                            <figure>
                                <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
                                    <img class="rounded-lg object-cover object-center shadow-lg" :src="service.image"
                                ...
                                <figcaption class="mt-3 flex text-sm text-gray-500">
                                    ...
                                    <span class="ml-2">{{ service.text }}</span>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                    <div class="mt-8 lg:mt-0">
                        <div v-for="detail in service.details" :key="detail.id"
...
const service = services.value.featured.find(i => i.id == id)
