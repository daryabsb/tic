    ...
    <div class="bg-white">
        ...
        <div class="relative bg-gray-800 pb-32">
            ...
            <div class="relative mx-auto max-w-7xl py-24 px-6 sm:py-32 lg:px-8">
                ...
                <div class="mt-6 max-w-full text-md text-gray-300" v-html="company" />
            </div>

        </div>

        <!-- Overlapping cards -->
        <section class="relative z-10 mx-auto -mt-32 max-w-7xl px-6 pb-16 lg:px-8" aria-labelledby="contact-heading">
