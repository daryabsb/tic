...
<template>
    <main ref="main" class="flex">
        <section class="s description panel blue">
            <div>
        ...
        <section class="s panel red">ONE</section>
        <section class="s panel orange">TWO</section>
        <section class="s panel purple">THREE</section>
        <section class="s panel green">FOUR</section>
    </main>
</template>
